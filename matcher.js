...
const SKILL_DB = new Set([
  ...
  "react", "angular", "vue", "node.js", "express", "fastapi", "flask", "django", "spring boot",
  "aws", "azure", "gcp", "docker", "kubernetes", "git", "linux", "agile", "scrum", "rest api",

  // --- FINANCE & BANKING ---
  "financial analysis", "financial modeling", "accounting", "valuation", "corporate finance", 
  "bloomberg", "excel", "vba", "forecasting", "auditing", "risk management", "investment banking", 
  "portfolio management", "equity research", "capital markets", "mergers and acquisitions", "m&a", 
  "gaap", "ifrs", "taxation", "financial reporting", "sap", "oracle", "quickbooks",

  // --- BUSINESS & MARKETING ---
  "market research", "digital marketing", "seo", "sem", "google analytics", "content strategy", 
  "social media marketing", "brand management", "crm", "salesforce", "hubspot", "negotiation", 
  "project management", "strategic planning", "business development", "public relations", 
  "email marketing", "copywriting", "lead generation",

  // --- DATA & ANALYTICS ---
  "data analysis", "tableau", "power bi", "statistics", "r", "sas", "spss", "big data", 
  "data visualization", "machine learning", "predictive modeling", "business intelligence",

  // --- ENGINEERING (Non-SW) ---
  "autocad", "solidworks", "matlab", "simulink", "cad", "cam", "ansys", "circuit design", 
  "pcb design", "lean manufacturing", "six sigma", "dfma", "quality control",

  // --- SOFT SKILLS / GENERAL ---
  "communication", "teamwork", "leadership", "problem solving", "critical thinking", 
  "time management", "adaptability", "creativity", "collaboration", "presentation", "public speaking"
]);

const STOP_WORDS = new Set([
  "a", "an", "the", "and", "or", "but", "in", "on", "at", "to", "for", "with", "by", "from", "up", "about",
  "into", "over", "after", "is", "are", "was", "were", "be", "been", "being", "have", "has", "had", "do",
  "does", "did", "can", "could", "will", "would", "shall", "should", "may", "might", "must", "of", "off",
  "as", "if", "than", "then", "that", "this", "these", "those", "it", "its", "they", "them", "their",
  "what", "which", "who", "whom", "whose", "when", "where", "why", "how", "all", "any", "both", "each",
  "few", "more", "most", "other", "some", "such", "no", "nor", "not", "only", "own", "same", "so",
  "too", "very", "s", "t", "can", "will", "just", "don", "should", "now", "we", "us", "our", "you", "your",
  "job", "role", "description", "requirements", "qualifications", "experience", "work", "team", "company",
  "looking", "seeking", "opportunity", "candidate", "responsibilities", "duties", "apply", "please", "contact",
  "proficiency", "proficient", "knowledge", "ability", "strong", "excellent", "good", "preferred", "plus"
]);
...
class JobMatcher {
  ...
  calculateScore(resumeText, jobDescriptionText) {
    ...
    const totalScore = (explicitScore * wExplicit) + (keywordScore * wKeyword) + (cosineScore * wCosine);
